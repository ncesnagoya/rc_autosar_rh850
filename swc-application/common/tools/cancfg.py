...
#  の責任を負わない．
#
# $Id: cancfg.py 122 2015-07-17 01:31:28Z ertl-honda $
#
...
inputstr = NewSetCCRHIncludes(inputstr, cfg_rel_includes, ['.', 'arch/rs_can', 'target/hsbrh850f1l_ccrh'], '../../../../a-comstack/can/')
...
cfg_command += " " + cfg_cfg1_def_tables + " --cfg1-def-table ../../../a-comstack/can/arch/rs_can/prc_def.csv " + cfg_includes 
