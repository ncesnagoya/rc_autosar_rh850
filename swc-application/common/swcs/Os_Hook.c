 ...
 *  の責任を負わない．
 *
 *  $Id: Os_Hook.c 122 2015-07-17 01:31:28Z ertl-honda $
 */
...
#ifdef TOPPERS_USE_BODY
	CddBodyControlInit();
#endif /* TOPPERS_USE_BODY */

#ifdef TOPPERS_USE_OPERATION
	CddControllerInit();
#endif /* TOPPERS_USE_OPERATION */

#ifdef TOPPERS_USE_CONTROL
	CddRcCarInit();
#endif /* TOPPERS_USE_CONTROL */
}
